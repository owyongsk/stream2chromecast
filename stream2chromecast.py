...
def play(filename, transcode=False, transcoder=None, transcode_options=None, transcode_input_options=None,
    ...
    if subtitles:
        sub = load_sub(subtitles, webserver_ip, subtitles_port)
...
def playurl(url, device_name=None, subtitles=None, subtitles_port=None):
...
def load_sub(subtitles, webserver_ip, subtitles_port):
    """ launches a web server for local subtitles """
...
def run():
    ...
    if args[0] == "-stop":
        ...
        arg2 = args[1]
        playurl(arg2, device_name=device_name, subtitles=subtitles)
